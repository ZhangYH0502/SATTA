...
def forward_and_adapt(x, model, optimizer):
    ...
    # outputs1 = outputs.view(outputs.shape[0], outputs.shape[1], -1)
    # outputs1 = torch.permute(outputs1, (2, 1, 0))
    # outputs1 = outputs1.view(outputs1.shape[0], -1)
...
if __name__ == '__main__':
    ...
    x = torch.Tensor(1, 4, 3, 3)
    y = -(x.softmax(1) * x.log_softmax(1)).sum(1)
    print(y.shape)
