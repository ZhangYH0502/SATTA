...
def get_args(parser):
    parser.add_argument('--data_root', type=str, default='/research/deepeye/zhangyuh/data/')
    parser.add_argument('--dataset', type=str, choices=['FluidSegDataset'], default='FluidSegDataset')
    parser.add_argument('--workers', type=int, default=0)
    parser.add_argument('--results_dir', type=str, default='results-4/')
    ...
    parser.add_argument('--name', type=str, default='CTforTrain_SforTest_1')
